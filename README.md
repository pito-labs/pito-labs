...
業界調査、企業への架電、顧客ヒアリング、課題仮説・事業仮説の構築、要件定義、デモ設計・実装、顧客へのデモ、PoC提案、価格提示までを共同で進めました。一部企業からは、動作条件を満たした場合の利用検討と、実データを用いた検証の許可を得る段階まで進みました。会社設立・正式ローンチに向け事業検証として実施したものです。
